//alert("hi");
var APIKey = "&appid=db250259dcb16cabf6f6fefe0e7b51da";
//Access weather API//
var cityArr =
...
function createSearchHistory(city) {
  ...
  $.ajax({
    ...
    //variables to be used to get uvIndex
...
function uvIndex(lon, lat) {
  ...
  //function to display UV Index info
  $.ajax({
    url: indexSearch,
    method: "GET",
  }).then(function (response) {
...
function fiveDay(city) {
  ...
  $.ajax({
    ...
    //adds humidity info to each card
